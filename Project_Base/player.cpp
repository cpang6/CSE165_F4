...
player::player (const char* filename, float x = 0, float y = 0, float w = 0.5, float h = 0.5) {
...
// For animation;
player::player (const char* map_filename, int rows, int cols, float x=0, float y=0, float w=0.5, float h=0.5) {
